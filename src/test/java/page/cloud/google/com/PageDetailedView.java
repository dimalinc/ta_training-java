...
import static util.Utils.waitForElementPresence;
...
public class PageDetailedView extends AbstractPage {
    ...
    public String getText_serverType() {
        return waitForElementPresence(driver,5000,250, text_serverType).getText();
    }

    public String getGpuModelText() {
        return waitForElementPresence(driver,5000,250, dropdown_gpu).getText();
    }

    public String getNumberOfInstancesText() {
        return waitForElementPresence(driver,5000,250, input_instancesQty).getText();
    }

    public boolean getGpusBoolean() {
        String tagText = waitForElementPresence(driver,5000,250, button_addGpu).getText();
    ...
    public String getDropdown_datacentreLocation() {
     //   System.out.println("regionText = " + regionText.getText());
        return waitForElementPresence(driver,5000,250, dropdown_datacentreLocation).getText();
    }

    public String getDropdown_ssd() {
        return waitForElementPresence(driver,5000,250, dropdown_ssd).getText();
    }
}
